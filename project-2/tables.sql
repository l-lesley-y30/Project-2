...
COPY Feeder
FROM '/home/lesley/Project-2/Feeder.csv'
DELIMITER ','
CSV HEADER;

COPY Programs
FROM '/home/lesley/Project-2/Programs.csv'
DELIMITER ','
CSV HEADER;

COPY Student_information
FROM '/home/lesley/Project-2/Student_information.csv'
DELIMITER ','
CSV HEADER; 


COPY Courses
FROM '/home/lesley/Project-2/Courses.csv'
DELIMITER ','
CSV HEADER;

COPY Grades
FROM '/home/lesley/Project-2/Grades.csv'
DELIMITER ','
CSV HEADER;

COPY Courses_Programs
FROM '/home/lesley/Project-2/Courses_Programs.csv'
DELIMITER ','
CSV HEADER;
